...
(function (KG) {
    var Restriction = (function (_super) {
        ...
        function Restriction(definition) {
            return _super.call(this, definition) || this;
        }
...
(function (KG) {
    var Selector = (function (_super) {
        ...
        function Selector(definition, modelPath) {
            return _super.call(this, definition, modelPath) || this;
        }
    ...
    (function (Functions) {
        var Base = (function (_super) {
            ...
            function Base(definition, modelPath) {
                var _this = _super.call(this, definition, modelPath) || this;
                var fn = _this;
    ...
    (function (Functions) {
        var Relation = (function (_super) {
            ...
            function Relation(definition, modelPath) {
                ...
                _this = _super.call(this, definition, modelPath) || this;
                var f = _this;
    ...
    (function (Functions) {
        var Monomial = (function (_super) {
            ...
            function Monomial(definition, modelPath) {
                ...
                _this.univariate = (definition.powers.length == 1);
                return _this;
            }
            // Establish setters
    ...
    (function (Functions) {
        var CobbDouglas = (function (_super) {
            ...
            function CobbDouglas(definition, modelPath) {
                ...
                _this = _super.call(this, monomialDef, modelPath) || this;
                return _this;
            }
            return CobbDouglas;
        }(Functions.Monomial));
        ...
        var Polynomial = (function (_super) {
            ...
            function Polynomial(definition, modelPath) {
                ...
                if (definition.hasOwnProperty('termDefs')) {
                    _this.terms = definition.termDefs.map(function (termDef) { return new Functions.Monomial(termDef); });
                }
                _this.bases = [0];
                return _this;
            }
    ...
    (function (Functions) {
        var Linear = (function (_super) {
            ...
            function Linear(definition, modelPath) {
                var _this = _super.call(this, definition, modelPath) || this;
                _this.linearIntersection = function (otherLine, delta) {
                    var thisLine = this;
                    delta = delta || 0;
                ...
                _this.quadraticIntersection = function (otherQuadratic, delta) {
                    var thisLine = this;
                    delta = delta || 0;
        ...
        var Quadratic = (function (_super) {
            ...
            function Quadratic(definition, modelPath) {
                ...
                if (!definition.hasOwnProperty('vertex') && definition.coefficients.a != 0) {
                    var negativeB = KG.multiplyDefs(-1, definition.coefficients.b), twoA = KG.multiplyDefs(2, definition.coefficients.a), vertexX = KG.divideDefs(negativeB, twoA), vertexY = _this.modelProperty('yValue(' + vertexX + ')');
                    definition.vertex = {
                        x: vertexX,
                        y: vertexY
                    };
    ...
    (function (Functions) {
        var Quasilinear = (function (_super) {
            ...
            function Quasilinear(definition, modelPath) {
                var _this = _super.call(this, definition, modelPath) || this;
                _this.coefficientDefs = definition.coefficients.map(function (c) { return c.toString(); });
                return _this;
            }
            // Establish setters
...
(function (KG) {
    var ViewObject = (function (_super) {
        ...
        function ViewObject(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            _this.interactionHandler = new KG.InteractionHandler(definition.interaction);
            return _this;
        }
        ...
        ViewObject.prototype.getAxes = function (view) {
            if (this.opposite) {
                return { x: view.xOppositeAxis, y: view.yOppositeAxis };
            }
            else {
                return { x: view.xAxis, y: view.yAxis };
            }
        };
...
(function (KG) {
    var Point = (function (_super) {
        ...
        function Point(definition, modelPath) {
            // NOTE: points cannot yet be defined in opposite coordinate space.
            // Use horizontalOppositeDropline and verticalOppositeDropline to draw droplines to the opposite side,
            // but coordinates must be set to lower-left origin for now.
            var _this = this;
            var defaultSize = 100;
            ...
            if (definition.droplines) {
                ...
                if (definition.droplines.hasOwnProperty('horizontalOpposite')) {
                    point.horizontalOppositeDropline = new KG.HorizontalOppositeDropline({
                        name: definition.name,
                        coordinates: definition.oppositeCoordinates,
                        interaction: _.clone(definition.interaction),
                        axisLabel: definition.droplines.horizontalOpposite,
                        className: definition.className,
                        show: definition.show
                    });
                }
                ...
                if (definition.droplines.hasOwnProperty('verticalOpposite')) {
                    point.verticalOppositeDropline = new KG.VerticalOppositeDropline({
                        name: definition.name,
                        coordinates: definition.oppositeCoordinates,
                        interaction: _.clone(definition.interaction),
                        axisLabel: definition.droplines.verticalOpposite,
                        className: definition.className,
                        show: definition.show
                    });
                }
        ...
        Point.prototype.createSubObjects = function (view) {
            ...
            if (view instanceof KG.TwoVerticalGraphs) {
                ...
                if (p.verticalOppositeDropline) {
                    view.addObject(p.verticalOppositeDropline);
                    p.verticalOppositeDropline.createSubObjects(view); // TODO should probably make this more recursive by default
                }
                if (p.horizontalDropline) {
                ...
                if (p.horizontalOppositeDropline) {
                    view.addObject(p.horizontalOppositeDropline);
                    p.horizontalOppositeDropline.createSubObjects(view); // TODO should probably make this more recursive by default
                }
            }
            return view;
        };
...
(function (KG) {
    var Dropline = (function (_super) {
        ...
        function Dropline(definition, modelPath) {
            ...
            if (definition.axisLabel.length > 0) {
                ...
                _this.labelDiv = new KG.GraphDiv(labelDef);
            }
            _this.viewObjectSVGtype = 'line';
            _this.viewObjectClass = 'dropline';
            return _this;
        }
        ...
        Dropline.prototype.render = function (view) {
            var dropline = this;
            var axes = this.getAxes(view);
            var pointX = axes.x.scale(dropline.coordinates.x), pointY = axes.y.scale(dropline.coordinates.y), anchorX = dropline.horizontal ? axes.x.scale(axes.x.min) : pointX, anchorY = dropline.horizontal ? pointY : axes.y.scale(axes.y.min);
    ...
    var VerticalOppositeDropline = (function (_super) {
        __extends(VerticalOppositeDropline, _super);
        function VerticalOppositeDropline(definition, modelPath) {
            var _this = this;
            if (definition.name.indexOf('_vOppositeDropline') == -1) {
                definition.name += '_vOppositeDropline';
            }
            definition.horizontal = false;
            definition.opposite = true;
            _this = _super.call(this, definition, modelPath) || this;
            return _this;
        }
        return VerticalOppositeDropline;
    }(Dropline));
    KG.VerticalOppositeDropline = VerticalOppositeDropline;
    ...
    var HorizontalOppositeDropline = (function (_super) {
        __extends(HorizontalOppositeDropline, _super);
        function HorizontalOppositeDropline(definition, modelPath) {
            var _this = this;
            if (definition.name.indexOf('_hOppositeDropline') == -1) {
                definition.name += '_hOppositeDropline';
            }
            definition.horizontal = true;
            definition.opposite = true;
            _this = _super.call(this, definition, modelPath) || this;
        ...
        return HorizontalOppositeDropline;
    }(Dropline));
    KG.HorizontalOppositeDropline = HorizontalOppositeDropline;
})(KG || (KG = {}));
var KG;
(function (KG) {
    var Curve = (function (_super) {
        ...
        Curve.prototype.positionLabel = function (view) {
            var curve = this, axes = this.getAxes(view), autoAlign = 'center', autoVAlign = 'middle';
            if (curve.labelDiv) {
                if (!curve.startPoint) {
                    ...
                    if (labelCoordinates.y > axes.y.domain.max) {
                        labelCoordinates.y = axes.y.domain.min * 0.05 + axes.y.domain.max * 0.95;
                        autoVAlign = 'bottom';
                    }
                    else if (labelCoordinates.x >= axes.x.domain.max) {
                        labelCoordinates.x = axes.x.domain.min * 0.05 + axes.x.domain.max * 0.95;
                        autoAlign = 'left';
                    }
                    else if (labelCoordinates.y < axes.y.domain.min) {
                        labelCoordinates.y = axes.y.domain.min * 0.95 + axes.y.domain.max * 0.05;
                        autoVAlign = 'top';
                    }
                    else if (labelCoordinates.x <= axes.x.domain.min) {
                        labelCoordinates.x = axes.x.domain.min * 0.95 + axes.x.domain.max * 0.05;
                        autoAlign = 'right';
                    }
                    else {
        ...
        Curve.prototype.render = function (view) {
            var curve = this, area = { draw: false, left: false, right: false, above: false, below: false }, axes = curve.getAxes(view);
            ...
            var dataCoordinates = view.dataCoordinates(curve.data, false, curve.opposite);
            ...
            if (curve.hasOwnProperty('area')) {
                if (curve.area.indexOf('ABOVE') > -1) {
                    dataLine = d3.svg.area()
                        ...
                        .y1(view.yAxis.scale(axes.y.max) - 10);
                }
                    ...
                    dataLine = d3.svg.area()
                        ...
                        .x(function (d) { return d.x; })
                        .y0(function (d) { return d.y; })
                        .y1(view.yAxis.scale(axes.y.min));
                }
                else {
            ...
            if (area.left) {
                group.select(selector + 'Left').attr({
                    ...
                    'd': dataLine([
                        { x: axes.x.scale(axes.x.min), y: area.below ? axes.y.scale(axes.y.max) : axes.y.scale(axes.y.min) },
                        { x: KG.arrayMinCoordinate(dataCoordinates) + 1, y: area.below ? axes.y.scale(axes.y.max) : axes.y.scale(axes.y.min) }
                    ])
                });
            }
            if (area.right) {
                group.select(selector + 'Right').attr({
                    ...
                    'd': dataLine([
                        { x: axes.x.scale(axes.x.max), y: area.below ? axes.y.scale(axes.y.max) : axes.y.scale(axes.y.min) },
                        { x: KG.arrayMaxCoordinate(dataCoordinates) - 1, y: area.below ? axes.y.scale(axes.y.max) : axes.y.scale(axes.y.min) }
                    ])
                });
            }
...
(function (KG) {
    var Line = (function (_super) {
        ...
        function Line(definition, modelPath) {
            ...
            if (definition.hasOwnProperty('yDomainDef')) {
                definition.lineDef.yDomainDef = definition.yDomainDef;
            }
            _this = _super.call(this, definition, modelPath) || this;
            var line = _this;
            var isHorizontal = (line instanceof HorizontalLine), isVertical = (line instanceof VerticalLine);
            if (isHorizontal) {
        ...
        Line.prototype.render = function (view) {
            ...
            if (startPoint == undefined || endPoint == undefined) {
                ...
                if (line.labelDiv) {
                    var labelPoint = void 0, labelAlign = (line.definition.hasOwnProperty('label') && line.definition.label.hasOwnProperty('align')) ? line.definition.label.align : 'left', labelValign = (line.definition.hasOwnProperty('label') && line.definition.label.hasOwnProperty('valign')) ? line.definition.label.valign : 'bottom';
...
(function (KG) {
    var GraphDiv = (function (_super) {
        ...
        GraphDiv.prototype.render = function (view) {
            var divObj = this, axes = divObj.getAxes(view);
            ...
            if (divObj.coordinates.x == GraphDiv.AXIS_COORDINATE_INDICATOR) {
                x = divObj.opposite ? view.dimensions.width - view.margins.right + axes.y.textMargin + 2 : view.margins.left - axes.y.textMargin - 2;
                divObj.align = divObj.opposite ? 'left' : 'right';
                ...
                x = view.margins.left + axes.x.scale(divObj.coordinates.x);
            }
            if (divObj.coordinates.y == GraphDiv.AXIS_COORDINATE_INDICATOR) {
                y = divObj.opposite ? view.margins.top - axes.x.textMargin : view.dimensions.height - view.margins.bottom + axes.x.textMargin;
                divObj.align = 'center';
                divObj.valign = divObj.opposite ? 'bottom' : 'top';
                if (!view.xAxis.domain.contains(divObj.coordinates.x)) {
                    divObj.className = 'invisible';
                }
            }
            else {
                y = view.margins.top + axes.y.scale(divObj.coordinates.y);
            }
            x += divObj.xOffset;
            y += divObj.yOffset;
...
(function (KG) {
    var LinePlot = (function (_super) {
        ...
        function LinePlot(definition, modelPath) {
            var _this = _super.call(this, definition, modelPath) || this;
            _this.viewObjectSVGtype = 'path';
            _this.viewObjectClass = 'dataPath';
            return _this;
        }
        return LinePlot;
    }(KG.Curve));
...
(function (KG) {
    var PathFamily = (function (_super) {
        ...
        function PathFamily(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            _this.viewObjectSVGtype = 'g';
            _this.viewObjectClass = 'dataPathFamily';
            return _this;
        }
...
(function (KG) {
    var Node = (function (_super) {
        ...
        function Node(definition, modelPath) {
            var _this = _super.call(this, definition, modelPath) || this;
            var n = _this;
            if (n.hasOwnProperty('children')) {
                n.children = definition.children.map(function (d) {
                    d.depth = n.depth + 1;
                    return new Node(d);
                });
            }
...
(function (KG) {
    var Edge = (function (_super) {
        ...
        function Edge(definition, modelPath) {
            return _super.call(this, definition, modelPath) || this;
        }
        Edge.prototype._update = function (scope) {
            var s = this;
            s.a = s.from.coordinates;
            s.b = s.to.coordinates;
            return s;
        };
        return Edge;
    }(KG.Segment));
    ...
    var View = (function (_super) {
        ...
        function View(definition, modelPath) {
            ...
            if (definition.hasOwnProperty('xAxisDef')) {
                _this.xAxis = new KG.XAxis(definition.xAxisDef);
            }
            if (definition.hasOwnProperty('yAxisDef')) {
                _this.yAxis = new KG.YAxis(definition.yAxisDef);
            }
            if (definition.hasOwnProperty('xOppositeAxisDef')) {
                _this.xOppositeAxis = new KG.XOppositeAxis(definition.xOppositeAxisDef);
            }
            if (definition.hasOwnProperty('yOppositeAxisDef')) {
                _this.yOppositeAxis = new KG.YOppositeAxis(definition.yOppositeAxisDef);
            }
        ...
        View.prototype.redraw = function () {
            var view = this;
            var elSelector = $('#' + view.element_id);
            // Establish dimensions of the view
            var element = elSelector[0];
            if (element == undefined) {
                return view;
            }
            var width = Math.min(6000, view.maxDimensions.width, element.clientWidth), height = Math.min(6000, view.maxDimensions.height, window.innerHeight - (10 + elSelector.offset().top - $(window).scrollTop()));
            if (view.square) {
            ...
            if (view.mask) {
                ...
                var axisMaskBorder = 0, openMaskBorder = 0;
            ...
            if (view.xAxis || view.yAxis) {
                ...
                if (view.xOppositeAxis) {
                    view.xOppositeAxis.update(view.scope).draw(axes, view.divs, axisDimensions, view.margins);
                }
                if (view.yOppositeAxis) {
                    view.yOppositeAxis.update(view.scope).draw(axes, view.divs, axisDimensions, view.margins);
                }
            }
...
(function (KG) {
    var Axis = (function (_super) {
        ...
        function Axis(definition, modelPath) {
            ...
            _this.domain = new KG.Domain(definition.min, definition.max);
            return _this;
        }
        ...
        Axis.prototype.scaleFunction = function (pixelLength, domain, reversed) {
            var rangeArray = reversed ? [pixelLength, 0] : [0, pixelLength], domainArray = domain.toArray();
            if (this.log) {
                return d3.scale.log()
                    .range(rangeArray)
                    .domain(domainArray);
    ...
    var XAxis = (function (_super) {
        ...
        XAxis.prototype.draw = function (vis, divs, graph_dimensions, margins) {
            var a = this;
            a.scale = a.scaleFunction(graph_dimensions.width, a.domain, false);
            if (a.show) {
                var axis_vis = vis.append('g')
                    .attr('class', 'x axis')
                    .attr("transform", "translate(0," + graph_dimensions.height + ")");
                axis_vis.call(d3.svg.axis().scale(a.scale).orient("bottom").ticks(a.ticks).tickValues(a.tickValues));
                var title = divs.append("div")
                    .style('text-align', 'center')
                    .style('position', 'absolute')
                    .style('width', graph_dimensions.width + 'px')
                    .style('height', (margins.bottom - a.axisBuffer) + 'px')
                    .style('left', margins.left + 'px')
                    .style('top', (margins.top + graph_dimensions.height + a.axisBuffer) + 'px')
                    .attr('class', 'medium');
                katex.render(a.title.toString(), title[0][0]);
            }
        };
        return XAxis;
    }(Axis));
    KG.XAxis = XAxis;
    var XOppositeAxis = (function (_super) {
        __extends(XOppositeAxis, _super);
        function XOppositeAxis() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        XOppositeAxis.prototype.draw = function (vis, divs, graph_dimensions, margins) {
            var a = this;
            a.scale = a.scaleFunction(graph_dimensions.width, a.domain, true);
            if (a.show) {
                var axis_vis = vis.append('g')
                    .attr('class', 'x axis');
                axis_vis.call(d3.svg.axis().scale(a.scale).orient("top").ticks(a.ticks).tickValues(a.tickValues));
                var title = divs.append("div")
                    .style('text-align', 'center')
                    .style('position', 'absolute')
                    .style('width', graph_dimensions.width + 'px')
        ...
        return XOppositeAxis;
    }(Axis));
    KG.XOppositeAxis = XOppositeAxis;
    var YAxis = (function (_super) {
        ...
        YAxis.prototype.draw = function (vis, divs, graph_dimensions, margins) {
            var a = this;
            a.scale = a.scaleFunction(graph_dimensions.height, a.domain, true);
            if (a.show) {
    ...
    KG.YAxis = YAxis;
    var YOppositeAxis = (function (_super) {
        __extends(YOppositeAxis, _super);
        function YOppositeAxis() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        YOppositeAxis.prototype.draw = function (vis, divs, graph_dimensions, margins) {
            var a = this;
            a.scale = a.scaleFunction(graph_dimensions.height, a.domain, false);
            if (a.show) {
                var axis_vis = vis.append('g').attr('class', 'y axis')
                    .attr("transform", "translate(" + graph_dimensions.width + ", " + 0 + ")");
                axis_vis.call(d3.svg.axis().scale(this.scale).orient("right").ticks(this.ticks).tickValues(this.tickValues));
                var title = divs.append("div")
                    .style('text-align', 'center')
                    .style('position', 'absolute')
                    .style('width', (graph_dimensions.height) + 'px')
                    .style('height', (margins.left - this.axisBuffer) + 'px')
                    .style('left', graph_dimensions.width + 0.5 * (margins.left - graph_dimensions.height - this.axisBuffer) + margins.left + 30 + 'px')
                    .style('top', margins.top + 0.5 * (graph_dimensions.height - margins.left + this.axisBuffer) + 'px')
                    .style('-webkit-transform', 'rotate(-90deg)')
                    .style('transform', 'rotate(-90deg)')
                    .attr('class', 'medium');
        ...
        return YOppositeAxis;
    }(Axis));
    KG.YOppositeAxis = YOppositeAxis;
})(KG || (KG = {}));
var KG;
(function (KG) {
    var Graph = (function (_super) {
        ...
        function Graph(definition, modelPath) {
            ...
            definition.margins = _.defaults(definition.margins || {}, { top: 50, left: 50, bottom: 70, right: 30 });
            _this = _super.call(this, definition, modelPath) || this;
            return _this;
        }
        ...
        Graph.prototype.pixelCoordinates = function (coordinates, moveToClosest, opposite) {
            var xAxis = opposite ? this.xOppositeAxis : this.xAxis, yAxis = opposite ? this.yOppositeAxis : this.yAxis;
            try {
        ...
        Graph.prototype.modelCoordinates = function (coordinates, moveToClosest, opposite) {
            var xAxis = opposite ? this.xOppositeAxis : this.xAxis, yAxis = opposite ? this.yOppositeAxis : this.yAxis;
        ...
        Graph.prototype.dataCoordinates = function (coordinateArray, moveToClosest, opposite) {
            var graph = this;
            var onGraphElements = coordinateArray.map(graph.onGraph, graph);
            var dataCoordinatesOnGraph = [];
            for (var i = 0; i < coordinateArray.length; i++) {
                if (moveToClosest) {
                    dataCoordinatesOnGraph.push(graph.pixelCoordinates(coordinateArray[i], true, opposite));
                }
                else if (onGraphElements[i] || onGraphElements[i - 1] || onGraphElements[i + 1]) {
                    dataCoordinatesOnGraph.push(graph.pixelCoordinates(coordinateArray[i], false, opposite));
                }
            }
...
(function (KG) {
    var TwoVerticalGraphs = (function (_super) {
        ...
        function TwoVerticalGraphs(definition, modelPath) {
            ...
            _this.topGraph = new KG.Graph(definition.topGraph);
            if (definition.hasOwnProperty('bottomGraph')) {
                definition.bottomGraph.element_id = definition.element_id + '_bottom';
                _this.bottomGraph = new KG.Graph(definition.bottomGraph);
            }
            return _this;
        }
...
(function (KG) {
    var Slider = (function (_super) {
        ...
        function Slider(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            _this.xAxis = new KG.XAxis(definition.axisDef);
            _this.objects = [
                new SliderControl({
    ...
    var SliderControl = (function (_super) {
        ...
        function SliderControl(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            _this.viewObjectSVGtype = 'g';
            _this.viewObjectClass = 'sliderControl';
            return _this;
        }
        SliderControl.prototype.render = function (view) {
            ...
            if (control.shape == 'bar') {
                ...
                var minX = view.xAxis.scale(Math.max(0, view.xAxis.domain.min)), maxX = view.xAxis.scale(control.param), minY = -view.dimensions.height * 0.5, maxY = 0;
                var bar = d3.svg.area()
                    .interpolate('linear')
                    .x(function (d) { return d.x; })
                    .y0(minY)
...
(function (KG) {
    var Tree = (function (_super) {
        ...
        function Tree(definition, modelPath) {
            var _this = this;
            definition.mask = true;
            definition.nodeDef.depth = 1;
            definition.xAxisDef = { min: 0, max: 25, ticks: 5, show: true };
            definition.yAxisDef = { min: 0, max: 25, ticks: 5, show: true };
            _this = _super.call(this, definition, modelPath) || this;
            var t = _this;
            t.root = new KG.Node(definition.nodeDef);
            t.root.coordinates = { x: 12, y: 2 };
            t.nodes = [];
            t.nodesAtDepth = [0, 0, 0, 0, 0, 0];
            t.maxDepth = 0;
            function parseNode(node) {
                t.nodes.push(node);
                t.nodesAtDepth[node.depth]++;
                t.objects.push(node);
                t.maxDepth = Math.max(t.maxDepth, node.depth);
                if (node.hasOwnProperty('children')) {
                    node.children.map(function (n) { parseNode(n); });
                }
            }
            parseNode(t.root);
...
var KG;
(function (KG) {
    var SignalingTree = (function (_super) {
        __extends(SignalingTree, _super);
        function SignalingTree(definition, modelPath) {
            return _super.call(this, definition, modelPath) || this;
        }
        return SignalingTree;
    }(KG.View));
    KG.SignalingTree = SignalingTree;
})(KG || (KG = {}));
var KG;
(function (KG) {
    var Controller = (function () {
        ...
        Controller.notationDefinitions = {
            ...
            varian: {
                ...
                slutskyInitial: 'X',
                slutskyFinal: 'Z',
                slutskyDecomposition: 'Y',
                /*laborLabel: 'Factor 1',
                capitalLabel: 'Factor 2',
                lLabel: 'x_1',
                kLabel: 'x_2',
                wLabel: 'w_1',
                rLabel: 'w_2',*/
...
(function (EconGraphs) {
    var PriceQuantityRelationship = (function (_super) {
        ...
        function PriceQuantityRelationship(definition, modelPath) {
            var _this = _super.call(this, definition, modelPath) || this;
            var priceQuantityRelationship = _this;
...
(function (EconGraphs) {
    var LinearPriceQuantityRelationship = (function (_super) {
        ...
        function LinearPriceQuantityRelationship(definition, modelPath) {
            ...
            else if (definition.hasOwnProperty('referenceQuantity') && definition.hasOwnProperty('referencePrice') && definition.hasOwnProperty('quantityIntercept')) {
                definition.def = {
                    point1: {
                        x: definition.referenceQuantity,
                        y: definition.referencePrice
    ...
    var LinearDemand = (function (_super) {
        ...
        function LinearDemand(definition, modelPath) {
            var _this = _super.call(this, definition, modelPath) || this;
            _this.marginalRevenue = _this.marginalDollarAmount;
            _this.totalRevenue = _this.totalDollarAmount;
            return _this;
        }
        return LinearDemand;
...
(function (EconGraphs) {
    var Utility = (function (_super) {
        ...
        function Utility(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            _this.utilityFunction = new KGMath.Functions[definition.type](definition.def);
            return _this;
        }
...
(function (EconGraphs) {
    var OneGoodUtility = (function (_super) {
        ...
        function OneGoodUtility(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            if (_this.utilityFunction.derivative()) {
                _this.marginalUtilityFunction = _this.utilityFunction.derivative();
            }
            return _this;
        }
...
(function (EconGraphs) {
    var RiskAversion = (function (_super) {
        ...
        function RiskAversion(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            _this.utility = new EconGraphs[definition.utilityType](definition.utilityDef, _this.modelPath + '.utility');
            return _this;
        }
...
(function (EconGraphs) {
    var CobbDouglasUtility = (function (_super) {
        ...
        function CobbDouglasUtility(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            _this.title = CobbDouglasUtility.title;
            return _this;
        }
...
(function (EconGraphs) {
    var ComplementsUtility = (function (_super) {
        ...
        function ComplementsUtility(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            _this.title = ComplementsUtility.title;
            return _this;
        }
...
(function (EconGraphs) {
    var SubstitutesUtility = (function (_super) {
        ...
        function SubstitutesUtility(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            _this.title = SubstitutesUtility.title;
            return _this;
        }
...
(function (EconGraphs) {
    var QuasilinearUtility = (function (_super) {
        ...
        function QuasilinearUtility(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            _this.title = QuasilinearUtility.title;
            return _this;
        }
    ...
    var Slutsky = (function (_super) {
        ...
        function Slutsky(definition, modelPath) {
            ...
            definition.decompositionBudget = {
                type: 'EconGraphs.SimpleBudgetConstraint',
                definition: {
                    income: 'model.budget2.px*model.initialBundle.x + model.budget2.py*model.initialBundle.y',
                    px: definition.px2,
                    py: definition.py2
                }
            };
            ...
            definition.pivotedDemand = {
                type: 'EconGraphs.MarshallianDemand',
                definition: {
                    utility: definition.utility,
                    budget: definition.decompositionBudget,
                    snapToOptimalBundle: true
                }
            };
        ...
        Slutsky.prototype._update = function (scope) {
            ...
            var pivotApproach = ("pivot" == scope.params.slutskyApproach);
            if (pivotApproach) {
                console.log('using pivot approach');
                s.pivotedDemand.update(scope);
                s.decompositionBundle = s.pivotedDemand.bundle;
            }
            else {
...
(function (EconGraphs) {
    var ProductionCost = (function (_super) {
        ...
        function ProductionCost(definition, modelPath) {
            ...
            productionCost.variableCostFunction = productionCost.costFunction.add(KG.subtractDefs(0, _this.modelProperty('fixedCost')));
...
(function (EconGraphs) {
    var ProductionTechnology = (function (_super) {
        ...
        ProductionTechnology.prototype.longRunAverageCostFn = function (params) {
            var f = this, LRAC = new KGMath.Functions.Base({});
            params = _.defaults(params || {}, { w: f.w, r: f.r });
            LRAC.yValue = function (q) {
                params.q = q;
                return f.longRunTotalCost(params) / q;
            };
            return LRAC;
        };
        ...
        ProductionTechnology.prototype.shortRunAverageCostFn = function (params) {
            var f = this, SRAC = new KGMath.Functions.Base({});
            params = _.defaults(params || {}, { w: f.w, r: f.r, K: f.K });
            SRAC.yValue = function (q) {
                params.q = q;
                return f.shortRunTotalCost(params) / q;
            };
            return SRAC;
        };
        /* Decorations */
...
(function (EconGraphs) {
    var CobbDouglasProduction = (function (_super) {
        ...
        function CobbDouglasProduction(definition, modelPath) {
            ...
            definition.yShare = KG.divideDefs(definition.yPower, sumOfPowers);
            _this = _super.call(this, definition, modelPath) || this;
            _this.title = CobbDouglasProduction.title;
            return _this;
        }
...
(function (EconGraphs) {
    var CompetitiveEquilibrium = (function (_super) {
        ...
        function CompetitiveEquilibrium(definition, modelPath) {
            ...
            _this = _super.call(this, definition, modelPath) || this;
            _this.supply = new EconGraphs.ProfitMax(definition.supply);
            _this.demand = new EconGraphs.MarshallianDemand(definition.demand);
            _this.marketSupply = new KGMath.Functions.Base({});
            _this.marketDemand = new KGMath.Functions.Base({});
            return _this;
        }
...
var EconGraphs;
(function (EconGraphs) {
    var QuantityDuopoly = (function (_super) {
        __extends(QuantityDuopoly, _super);
        function QuantityDuopoly(definition, modelPath) {
            var _this = _super.call(this, definition, modelPath) || this;
            var duopoly = _this;
            duopoly.marketDemand = new EconGraphs.LinearDemand({
                type: 'Linear',
            ...
            }, _this.modelProperty('marketDemand'));
            console.log(duopoly.modelProperty('firm2.quantity'));
            duopoly.firm1 = new EconGraphs.ProfitMax({
                ...
                demandFunction: {
                    ...
                    definition: {
                        priceIntercept: 'model.residualDemandPriceIntercept(1)',
                        quantityIntercept: 'model.residualDemandQuantityIntercept(1)'
                    }
                },
                snapToOptimal: definition.snapToOptimal1
            }, duopoly.modelProperty('firm1'));
            duopoly.firm2 = new EconGraphs.ProfitMax({
                ...
                demandFunction: {
                    type: 'EconGraphs.LinearDemand',
                    definition: {
                        priceIntercept: 'model.residualDemandPriceIntercept(2)',
                        quantityIntercept: 'model.residualDemandQuantityIntercept(2)'
                    }
                },
                snapToOptimal: definition.snapToOptimal2
            }, duopoly.modelProperty('firm2'));
            return _this;
        }
        QuantityDuopoly.prototype.residualDemandPriceIntercept = function (firm) {
            var otherFirmQuantity = (firm == 2) ? this.firm1.quantity : this.firm2.quantity;
            return this.marketDemand.priceAtQuantity(otherFirmQuantity);
        };
        QuantityDuopoly.prototype.residualDemandQuantityIntercept = function (firm) {
            var otherFirmQuantity = (firm == 2) ? this.firm1.quantity : this.firm2.quantity;
            console.log('firm: ', firm, ', other firm quantity: ', otherFirmQuantity);
            return this.marketDemand.quantityAtPrice(0) - otherFirmQuantity;
        };
        QuantityDuopoly.prototype._update = function (scope) {
            var duopoly = this;
            duopoly.marketDemand.update(scope);
            duopoly.firm1.update(scope);
            duopoly.firm2.update(scope);
            duopoly.firm1.update(scope);
            duopoly.firm2.update(scope);
            duopoly.marketDemand.quantity = duopoly.firm1.quantity + duopoly.firm2.quantity;
            duopoly.marketDemand.price = duopoly.marketDemand.priceAtQuantity(duopoly.marketDemand.quantity);
            duopoly.firm1.update(scope);
            duopoly.firm2.update(scope);
            return duopoly;
        };
        return QuantityDuopoly;
    }(KG.Model));
    EconGraphs.QuantityDuopoly = QuantityDuopoly;
})(EconGraphs || (EconGraphs = {}));
/// <reference path="../../../eg.ts"/>
var EconGraphs;
(function (EconGraphs) {
...
(function (EconGraphs) {
    var Edgeworth = (function (_super) {
        ...
        function Edgeworth(definition, modelPath) {
            var _this = this;
            definition = _.defaults(definition, {
                endowmentA: { x: 100, y: 100 },
                xTotal: 200,
                yTotal: 200,
                priceRatio: 1,
                utilityA: {
        ...
        Edgeworth.prototype._update = function (scope) {
            var e = this;
            e.utilityA.update(scope);
            e.utilityB.update(scope);
            e.endowmentB = e.bAllocation(e.endowmentA);
            return e;
        };
        Edgeworth.prototype.bAllocation = function (bundle) {
            var e = this;
            return { x: e.xTotal - bundle.x, y: e.yTotal - bundle.y };
        };
        Edgeworth.prototype.equilibriumPriceRatio = function () {
            var e = this;
            if (e.utilityA instanceof EconGraphs.CobbDouglasUtility && e.utilityB instanceof EconGraphs.CobbDouglasUtility) {
                var num = e.utilityA.xShare * e.endowmentA.y + e.utilityB.xShare * e.endowmentB.y, den = e.utilityA.yShare * e.endowmentA.x + e.utilityB.yShare * e.endowmentB.x;
                return num / den;
            }
            else {
                console.log('Cannot yet do contract curves for non-CD utility functions, sorry.');
            }
        };
        Edgeworth.prototype.equilibriumAllocation = function (agent) {
            agent = agent || 'A';
            var e = this;
            e.priceRatio = e.equilibriumPriceRatio();
            if (e.utilityA instanceof EconGraphs.CobbDouglasUtility && e.utilityB instanceof EconGraphs.CobbDouglasUtility) {
                return { x: e.demand(agent, 'x', false), y: e.demand(agent, 'y', false) };
            }
            else {
                console.log('Cannot yet do contract curves for non-CD utility functions, sorry.');
            }
        };
        Edgeworth.prototype.demand = function (agent, good, net, p) {
            var e = this;
            if ('A' != agent && 'B' != agent) {
                console.log('Agent must be A or B, currently ', agent);
                return 0;
            }
            if ('x' != good && 'y' != good) {
                console.log('Good must be x or y, currently ', good);
                return 0;
            }
            p = p || e.priceRatio;
            var u = e['utility' + agent], w = e['endowment' + agent], m = p * w.x + w.y;
            var grossDemand = 0;
            if (u instanceof EconGraphs.CobbDouglasUtility) {
                grossDemand = (good == 'x') ? u.xShare * m / p : u.yShare * m;
            }
            else {
                console.log('Not handling anything but Cobb-Douglas yet!');
            }
            if (net) {
                return grossDemand - w[good];
            }
            else {
                return grossDemand;
            }
        };
        Edgeworth.prototype.optimalBundle = function (agent, p) {
            return { x: this.demand(agent, 'x', false, p), y: this.demand(agent, 'y', false, p) };
        };
        Edgeworth.prototype.agentDemanding = function (good) {
            var e = this, AdemandsX = (e.utilityA.mrs(e.endowmentA) > e.utilityB.mrs(e.endowmentB));
            if ('x' == good) {
                return AdemandsX ? 'A' : 'B';
            }
            if ('y' == good) {
                return AdemandsX ? 'B' : 'A';
            }
            console.log('good must be x or y');
            return null;
        };
        Edgeworth.prototype.agentSupplying = function (good) {
            return ('A' == this.agentDemanding(good)) ? 'B' : 'A';
        };
        Edgeworth.prototype.demandCurveData = function (good) {
            var e = this, agent = e.agentDemanding(good), invertPrice = ('y' == good), samplePoints = KG.samplePointsForDomain({
                min: 0.1,
                max: 10,
                numSamplePoints: 100
            });
            ...
            samplePoints.forEach(function (p) {
                dc.push({ x: e.demand(agent, good, true, p), y: invertPrice ? 1 / p : p });
            });
            return dc;
        };
        Edgeworth.prototype.supplyCurveData = function (good) {
            var e = this, agent = (e.agentDemanding(good) == 'A') ? 'B' : 'A', invertPrice = ('y' == good), samplePoints = KG.samplePointsForDomain({
                min: 0.1,
                max: 10,
                numSamplePoints: 100
            });
        ...
        Edgeworth.prototype.offerCurveData = function (agent) {
            var e = this, samplePoints = KG.samplePointsForDomain({
                min: 0,
                max: 0.99,
                numSamplePoints: 100
            });
            ...
            samplePoints.forEach(function (p) {
                e.priceRatio = p / (1 - p);
                oc.push({ x: e.demand(agent, 'x', false), y: e.demand(agent, 'y', false) });
            });
            return oc;
        };
        // returns point on the contract curve for point x
        Edgeworth.prototype.yContract = function (x) {
            var e = this;
            if (e.utilityA instanceof EconGraphs.CobbDouglasUtility && e.utilityB instanceof EconGraphs.CobbDouglasUtility) {
                return e.yTotal / (1 + (e.utilityA.xPower / e.utilityA.yPower) * (e.utilityB.yPower / e.utilityB.xPower) * (e.xTotal - x) / x);
            }
            else {
                console.log('Cannot yet do contract curves for non-CD utility functions, sorry.');
            }
        };
        Edgeworth.prototype.contractCurveData = function () {
            var e = this, samplePoints = KG.samplePointsForDomain({
                min: 1,
                max: e.xTotal,
                numSamplePoints: 100
            ...
            var cd = [{ x: 0, y: 0 }];
            samplePoints.forEach(function (x) {
                cd.push({ x: x, y: e.yContract(x) });
            });
            return cd;
        };
        return Edgeworth;
    }(KG.Model));
    EconGraphs.Edgeworth = Edgeworth;
})(EconGraphs || (EconGraphs = {}));
var EconGraphs;
(function (EconGraphs) {
    var RamseyCassKoopmans = (function (_super) {
        ...
        function RamseyCassKoopmans(definition, modelPath) {
            var _this = _super.call(this, definition, modelPath) || this;
            _this.steadyCapital = new KGMath.Functions.Polynomial({ termDefs: [
                    {
                        coefficient: 1,
                        powers: ['params.alpha']
                    },
...
//# sourceMappingURL=kg-v0.06.js.map